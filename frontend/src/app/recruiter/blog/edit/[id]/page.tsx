...
export default function EditBlogPage() {
    ...
    useEffect(() => {
        const fetchPost = async () => {
            try {
                // Assuming getPostBySlug works with ID as per backend implementation or we can add getPostById
                // The backend controller for getPostBySlug handles ID lookup too: "SELECT * FROM blog_posts WHERE slug = ${slug} OR id::text = ${slug}"
                ...
                router.push("/recruiter/blog/manage");
            } finally {
                setLoading(false);
            }
        };
